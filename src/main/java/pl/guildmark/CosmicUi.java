...
public final class CosmicUi {
    ...
    private static void shadowLayer(DrawContext c, int x, int y, int w, int h, int radius, int rgb, float strength, int spread, int alpha) {
        int a = MathHelper.clamp((int)(alpha * strength), 0, 255);
